...
const CodeforcesContestListOfNonParticipants = () => {
            ...
            loading ?
               ...
               contestData.map(contest =>
                  <div key={contest._id} className="bg-zinc-900 h-20 flex justify-center items-center rounded-lg w-[95%] lg:w-[50%] mx-auto mb-8">
                     <Link to={`/resultTypes/codeforcesContestListOfNonParticipants/${parseInt(contest.contestId)}`} >
...
export default CodeforcesContestListOfNonParticipants;