...
const ResultTypes = () => {
   return (
      <div className="grid grid-cols-1 md:grid-cols-2 mt-8 gap-8 w-[85%] lg:w-[80%] mx-auto">
         <Helmet>
            <title>Result</title>
         </Helmet>
         <div className="bg-zinc-900 h-20 flex justify-center items-center rounded-lg w-[95%]">
